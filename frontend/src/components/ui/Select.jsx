    ...
    <div className={twMerge('w-full flex flex-col gap-1.5', containerClassName)}>
      ...
      <div className="relative flex items-center">
        ...
        <select
          ...
          className={twMerge(
            clsx(
              'w-full text-sm bg-white dark:bg-dark-input text-slate-900 dark:text-slate-100 border rounded-xl transition-colors duration-150 appearance-none cursor-pointer',
